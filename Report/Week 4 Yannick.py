...
mergedData['delay_nights'] = mergedData['delay_nights'].astype(int)
mergedData['delay_time'] = mergedData['delay_time'].astype(int)

#Histogram of delay nights
plt.hist(mergedData['delay_nights'], label = 'Delay nights')
...
plt.hist(mergedData['delay_time'], label = 'Delay time')
plt.legend(loc = 'upper right')
